...
QWEN_MLX_MODELS_DIR = MODELS_DIR / "qwen3-asr-mlx"
...
# 创建目录
for d in [PROJECTS_DIR, DOWNLOADS_DIR, AUDIO_DIR, SUBTITLES_DIR, EXPORTS_DIR, MODELS_DIR, MLX_MODELS_DIR, QWEN_MLX_MODELS_DIR, LOGS_DIR]:
